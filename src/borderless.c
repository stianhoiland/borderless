...
{
	static CONST LONG_PTR style_mask = WS_CAPTION | WS_MAXIMIZEBOX | WS_MINIMIZEBOX | WS_SYSMENU | WS_THICKFRAME;
	static CONST LONG_PTR exstyle_mask = WS_EX_CLIENTEDGE | WS_EX_STATICEDGE | WS_EX_WINDOWEDGE | WS_EX_DLGMODALFRAME;
	static struct undo {
		HWND hwnd;
		LONG_PTR style;
		LONG_PTR exstyle;
